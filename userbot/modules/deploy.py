...
async def _(event):
   ...
   # input_str = event.pattern_match.group(1)
    ...
    animation_chars = [
        ...
        "Heroku Connecting To Latest Github Build (Ouraaa/Ouraa-ubot)",
        ...
        "INFO - Ouraa-Userbot: Logged in as 557667062",
        "INFO - Ouraa-Userbot: Successfully...",
        "919852+00:00 app[worker.1]: 919 - Kyy-Userbot -",
        "INFO -  ✨ᴏᴜʀᴀᴀ-ᴜʙᴏᴛ✨  ⚙️ V5.0 [TELAH DIAKTIFKAN!]",
        "**Build Succeeded**"
